...
describe('/course', () => {
    ...
    it("Should create course with correct input data", async () => {
        ...
        await (0, supertest_1.default)(app_1.app)
            .get('/courses')
            .expect(statuses_1.HTTP_STATUSES.OK_200, [createdCourseOne]);
    });
    ...
    it("create one more course", async () => {
        ...
        await (0, supertest_1.default)(app_1.app)
            .get('/courses')
            .expect(statuses_1.HTTP_STATUSES.OK_200, [createdCourseOne, createdCourseTwo]);
    });
    ...
    it("Should update course with correct input data", async () => {
        ...
        await (0, supertest_1.default)(app_1.app)
            ...
            .expect(statuses_1.HTTP_STATUSES.OK_200, createdCourseTwo);
    });
